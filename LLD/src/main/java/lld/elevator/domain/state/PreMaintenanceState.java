package lld.elevator.domain.state;

import lld.elevator.domain.Elevator;
import lld.elevator.domain.ElevatorState;
...
public class PreMaintenanceState implements ElevatorStateHandler {
     ...
     */
    public void checkForMaintenanceTransition(lld.elevator.domain.Elevator elevator) {
